...
class Gamepad(displayio.Group):
    def __init__(self, port: int, size: int = 100):
        ...
        self._buttons = (
            (relic_usb_host_gamepad.BUTTON_A, 0.85, 0.4),
            (relic_usb_host_gamepad.BUTTON_B, 0.8, 0.5),
            (relic_usb_host_gamepad.BUTTON_X, 0.8, 0.3),
            (relic_usb_host_gamepad.BUTTON_Y, 0.75, 0.4),
            (relic_usb_host_gamepad.BUTTON_LEFT, 0.15, 0.4),
            (relic_usb_host_gamepad.BUTTON_RIGHT, 0.25, 0.4),
            (relic_usb_host_gamepad.BUTTON_UP, 0.2, 0.3),
            (relic_usb_host_gamepad.BUTTON_DOWN, 0.2, 0.5),
            (relic_usb_host_gamepad.BUTTON_START, 0.6, 0.4),
            (relic_usb_host_gamepad.BUTTON_SELECT, 0.4, 0.4),
            (relic_usb_host_gamepad.BUTTON_HOME, 0.5, 0.4),
            (relic_usb_host_gamepad.BUTTON_L1, 0.1, 0.1),
            (relic_usb_host_gamepad.BUTTON_L2, 0.2, 0.1),
            (relic_usb_host_gamepad.BUTTON_L3, 0.3, 0.1),
            (relic_usb_host_gamepad.BUTTON_R1, 0.9, 0.1),
            (relic_usb_host_gamepad.BUTTON_R2, 0.8, 0.1),
            (relic_usb_host_gamepad.BUTTON_R3, 0.7, 0.1),
            (relic_usb_host_gamepad.BUTTON_JOYSTICK_LEFT, 0.25, 0.75),
            (relic_usb_host_gamepad.BUTTON_JOYSTICK_RIGHT, 0.45, 0.75),
            (relic_usb_host_gamepad.BUTTON_JOYSTICK_UP, 0.35, 0.6),
            (relic_usb_host_gamepad.BUTTON_JOYSTICK_DOWN, 0.35, 0.9),
        )
        self._circles = []
